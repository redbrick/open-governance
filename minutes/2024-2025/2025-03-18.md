...
## SysAdmins:
- Jakeing it and by it I mean by admin exam
...
## Points of Discusion:
- Clarification of exam expiry and rerunning (yes, magma can run for re-election) - `Secretary`
...
- [ ] `admins` - Write Exam
- [ ] `SysAdmin`, `claudia` - CS BALL Meeting
