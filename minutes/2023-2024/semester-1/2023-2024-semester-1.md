...
- ### SysAdmins:
    ...
    - chatting with `rootholder` yesterday, planning to make a route from aperture to old redbrick but still don't fully understand the network topology - `sysadmin`
...
- ### Webmaster:
    ...
    - Setup a [GitHub project board](https://github.com/orgs/redbrick/projects/4) for Webgroup - `webmaster`
        - `rootholder` suggested using [YouTrack](https://www.jetbrains.com/youtrack/) - ![](https://cdn.discordapp.com/emojis/1047306349194789005.webp?size=24&quality=lossless)
- ### PRO:
    - 
- ### GDO:
    - 
...
- ### Ordinary Members:
    - 
- ### Common Room Committee:
    - Will meet with Noel Murphy about Santy list and croom changes - `events`
- ### Points of Discussion:
    - Hoodies
...
- ## Points of Info:
    ...
    - ### SysAdmin Update:
        ...
        - networking with `rootholder`
            - `chair` and `rootholder`
...
- ## Points of Discusion:
    - Hoodies
        ...
        - gdsc devfest
            ...
            - give money to societies to run `events`
            - similar to sistem
            - december, 2pm to 8pm
            - held in tud
...
- ### Common Room Committee:
    ...
    - Sent email for Croom equipment to Cathal Gurrin and Gavin Osborne 😎 - `events`
...
- ## Points of Discusion:
    ...
    - GDSC TUD
        ...
        - team hasn't run event before, asked for help
...
- ## Points of Info:
    - ### Chair Update:
        - Intersocs ball
            ...
            - just an idea
            - james bond potentially (one of the easier)
            - going for james bond
            - 130 people -55-60 
    ...
    - ### SysAdmin Update:
        ...
        - common room mailing list
            ...
            - Gavin in charge of common room, `vice-chair` will let them know about email
