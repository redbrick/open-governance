...
- ### Webmaster:
    ...
    - Setup a [GitHub project board](https://github.com/orgs/redbrick/projects/4) for Webgroup - `webmaster`
        - ~~Malachy~~ `sysadmin` suggested using [YouTrack](https://www.jetbrains.com/youtrack/) - ![](https://cdn.discordapp.com/emojis/1047306349194789005.webp?size=24&quality=lossless)
- ### PRO:
    - 
- ### GDO:
    - 
...
- ### Common Room Committee:
    ...
    - Natasha finally got them keycards, big woop! Only took a year - `events`
- ### Points of Discussion:
