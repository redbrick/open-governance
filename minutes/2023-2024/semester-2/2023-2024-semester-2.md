...
- ## AOB:
    ...
    - georjie hoodie
        ...
        - guessing his was given away instead of a blank one
...
- :smiley_cat: `vice-chair` trying his best
...
- :heart: `sysadmin`, he has done a solid job with maintaining the services, migrating over to aperture and defining requirements and risks for services in the future. I have appreciated our chats about Redbrick.
- :heart: Newletters and finance have been timely and reliable, very proud of our Secretary and Treasurer!
- :heart: `chair` has put a lot of effort into Redbrick, and ensuring it will thrive after he (and I) are gone.
...
- ## Points of Info:
    ...
    - ### Vice-Chair Update:
        ...
        - bank signatories
            ...
            - can get a letter from `sysadmin` stating she resigned
...
- ### Events:
    ...
    - Did Keith fix OMS event submissions with his upgrade? - `events`
- ### Treasurer:
    - 
- ### HelpDesk:
    - 
...
- ## Points of Info:
    ...
    - ### SysAdmin Update:
        ...
        - ISS responded, we may get discount from Dell on RAM; we may be able to go for more RAM given CnS funds
            ...
            - `events`bie says mail not broke!  (emailed `sysadmin` while he was an eepy weepy comfy guy.) We have 2 weeks to update otherwise blacklisted but lol nvm because of basic security. 
            ...
            - `chair` spills his monster - applause erupts in the committee
    ...
    - ### Events Update:
        ...
        - `webmaster` wondering who is doing a talk - he would like to talk but is too chicken (screw you -`webmaster`)
...
- ##Techweek
    ...
    - `chair` asks whether we have two talks per day for TW: Yes from `events` - Ania needs to get back to her but `events` is confident that each day is pretty well filled up at the moment. 
    ...
    - Max's time is confirmed with him by `events`
